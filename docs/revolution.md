...
- 新增 [examples/benchmark_segmented.py](../examples/benchmark_segmented.py)
- 生成 [benchmarks/segmented_v1.md](../benchmarks/segmented_v1.md)
...
- 新增 [examples/benchmark_segmented_workload.py](../examples/benchmark_segmented_workload.py)
- 生成 [benchmarks/segmented_workload.md](../benchmarks/segmented_workload.md)
...
- benchmark script: [examples/benchmark_segmented_spec_gate.py](../examples/benchmark_segmented_spec_gate.py)
- benchmark report: [benchmarks/segmented_spec_gate.md](../benchmarks/segmented_spec_gate.md)
...
- Track B：
  ...
  - 新增 [examples/file_batch_workflow.py](../examples/file_batch_workflow.py)
- Track C：
...
- 新增 [examples/benchmark_real_workload.py](../examples/benchmark_real_workload.py)
...
- 输出：
  ...
  - [benchmarks/profile.md](../benchmarks/profile.md)
...
- `docs/revolution.md` 现有文件编码显示异常，新增记录虽然可读，但旧内容仍可能在部分终端里出现乱码
...
- 补充语义测试：
  ...
  - 不允许回退到 `rolling_map`
- 新增专项 benchmark：
  - [examples/benchmark_positional_rolling.py](../examples/benchmark_positional_rolling.py)
  - [benchmarks/positional_rolling.md](../benchmarks/positional_rolling.md)
...
- 语义保持不变：
  ...
  - 前缀行继续使用部分窗口
- 目标测试通过：
  - `tests/test_executor_new_functions.py`
  - `tests/test_ordered_audit.py`
  - `tests/test_engine_new_functions.py`
...
- 目标测试通过：
  ...
  - `tests/test_planner.py`
  - `tests/test_engine.py`
- benchmark 已更新到 [benchmarks/positional_rolling.md](../benchmarks/positional_rolling.md)
...
- 新增 stage lifecycle benchmark：
  - [examples/benchmark_stage_lifecycle.py](../examples/benchmark_stage_lifecycle.py)
  - [benchmarks/stage_lifecycle.md](../benchmarks/stage_lifecycle.md)
- 新增 lifecycle 设计文档：
