...
- segmented window v1：
  - 脚本入口：[benchmarks/scripts/benchmark_segmented.py](../../benchmarks/scripts/benchmark_segmented.py)
  - 结果记录：[benchmarks/reports/segmented_v1.md](../../benchmarks/reports/segmented_v1.md)
  - 关注问题：`segment_id` 是否为主瓶颈、`evaluate_many()` 是否存在重复预处理、不同 `segment_count` 是否带来显著额外成本
- segmented workload benchmark：
  - 脚本入口：[benchmarks/scripts/benchmark_segmented_workload.py](../../benchmarks/scripts/benchmark_segmented_workload.py)
  - 结果记录：[benchmarks/reports/segmented_workload.md](../../benchmarks/reports/segmented_workload.md)
...
- segmented spec gate benchmark：
  - 脚本入口：[benchmarks/scripts/benchmark_segmented_spec_gate.py](../../benchmarks/scripts/benchmark_segmented_spec_gate.py)
  - 结果记录：[benchmarks/reports/segmented_spec_gate.md](../../benchmarks/reports/segmented_spec_gate.md)
  - 关注问题：length-based segmentation 的成本边界、spec diversity 的增长代价、count+length 混合 workload 的放大效应
- positional rolling benchmark：
  - 脚本入口：[benchmarks/scripts/benchmark_positional_rolling.py](../../benchmarks/scripts/benchmark_positional_rolling.py)
  - 结果记录：[benchmarks/reports/positional_rolling.md](../../benchmarks/reports/positional_rolling.md)
...
- 脚本：[benchmarks/scripts/benchmark_segmented_spec_gate.py](../../benchmarks/scripts/benchmark_segmented_spec_gate.py)
- 报告：[benchmarks/reports/segmented_spec_gate.md](../../benchmarks/reports/segmented_spec_gate.md)
- workload 约定：
...
- script: [benchmarks/scripts/benchmark_stage_lifecycle.py](../../benchmarks/scripts/benchmark_stage_lifecycle.py)
- report: [benchmarks/reports/stage_lifecycle.md](../../benchmarks/reports/stage_lifecycle.md)
- detailed outputs: `benchmarks/latest/stage_lifecycle/*/{latest_run.json,history.csv,latest_batch_details.jsonl,latest_stage_details.jsonl,latest_stage_events.jsonl,benchmark_report.md}`
...
- focused tests: `python -m pytest tests\profiling\test_stage_lifecycle.py -q`
...
- 脚本入口：[benchmarks/scripts/benchmark_real_workload.py](../../benchmarks/scripts/benchmark_real_workload.py)
- 基线结果：[benchmarks/reports/baseline.md](../../benchmarks/reports/baseline.md)
- 分阶段 profile：[benchmarks/reports/profile.md](../../benchmarks/reports/profile.md)
