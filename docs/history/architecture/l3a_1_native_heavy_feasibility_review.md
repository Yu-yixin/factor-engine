...
```text
benchmarks/scripts/benchmark_r4_executor_reuse.py --rows 1000 --consumer-counts 2 --workloads native_heavy_probe,native_heavy_nested,native_heavy_multi_read --lifecycle-mode off
benchmarks/scripts/benchmark_r4_executor_reuse.py --rows 1000000 --consumer-counts 2 --workloads native_heavy_probe,native_heavy_nested,native_heavy_multi_read --lifecycle-mode off
benchmarks/scripts/benchmark_r4_executor_reuse.py --rows 0 --consumer-counts 2 --workloads native_heavy_multi_read --lifecycle-mode off
```
