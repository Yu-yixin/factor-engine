...
```text
benchmarks/scripts/benchmark_r4_executor_reuse.py --rows 1000000 --consumer-counts 2 --workloads repeated_heavy,multi_shared_nodes,nested_dag,partial_reuse --lifecycle-mode off
benchmarks/scripts/benchmark_r4_executor_reuse.py --rows 1000000 --consumer-counts 2 --workloads repeated_heavy,multi_shared_nodes,nested_dag,partial_reuse --lifecycle-mode first_wave
benchmarks/scripts/benchmark_r4_executor_reuse.py --rows 0 --consumer-counts 2 --workloads repeated_heavy,multi_shared_nodes,nested_dag,partial_reuse --lifecycle-mode first_wave
```
