...
1. Phase 3.1: create `src/factor_engine/executor_utils.py` and move pure utility helpers only. Keep `Executor` compatibility wrappers for any private helper already touched by tests.
