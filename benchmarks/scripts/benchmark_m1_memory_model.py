...
from benchmark_positional_phases import build_expressions as build_positional_expressions  # noqa: E402
from benchmark_stage_lifecycle import build_workload as build_synthetic_workload  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=PROJECT_ROOT / "benchmarks" / "latest" / "m1_memory_model",
    )
